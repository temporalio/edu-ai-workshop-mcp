...
class GetWeatherChart:
    ...
    async def get_weather_chart(self, latitude: float, longitude: float, use_post_method: bool = False) -> dict:
        ...
        points_url = f"{NWS_API_BASE}/points/{latitude},{longitude}"
        points_data = await workflow.execute_activity(
            # TODO Part B: Pass in your make_nws_request Activity
            # TODO Part B: Pass in your points_url
            # TODO Part B: Set your Schedule-To-Close timeout to be 40 seconds
            retry_policy=retry_policy,
        )
        ...
        chart_url = await workflow.execute_activity(
            # TODO Part B: Call your `generate_weather_chart` Activity.
        ...
        return {
            ...
            "chart_url": chart_url,
            "summary": summary,
            "message": # TODO Part B: Add your own success message that is returned by the Workflow.
        }